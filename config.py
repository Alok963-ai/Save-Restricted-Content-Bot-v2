...
MONGO_URI = os.getenv("MONGO_DB", "mongodb+srv://alokjangde6:1q9XguXoXiV6HMog@cluster0.cx60pkr.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
OWNER_ID = list(map(int, os.getenv("OWNER_ID", "7833842279").split())) # list seperated via space
DB_NAME = os.getenv("DB_NAME", "telegram_downloader")
STRING = os.getenv("STRING", None) # optional
LOG_GROUP = int(os.getenv("LOG_GROUP", -1002685528774))) # optional with -100
FORCE_SUB = int(os.getenv("FORCE_SUB", -1002593725971)) # optional with -100
